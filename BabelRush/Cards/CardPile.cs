...
public sealed class CardPile : IReadOnlyCollection<Card>
{
    ...
    public bool AddCard(Card card, bool toTop = true)
    {
        ...
        GameNode.EventBus.Publish(new CardInsertedToPileEvent(this, card));
        return true;
    }
    ...
    public bool RemoveCard(Card card)
    {
        ...
        GameNode.EventBus.Publish(new CardRemovedFromPileEvent(this, card));
        return true;
    }
    ...
    public Card? PickCard(int index = 0, bool fromTop = true)
    {
        ...
        {
            Cards.Remove(node);
            GameNode.EventBus.Publish(new CardRemovedFromPileEvent(this, node.Value));
        }
        return node?.Value;
    }
